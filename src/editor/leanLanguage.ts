...
export function configureLeanLanguage(monaco: Monaco) {
  ...
  monaco.editor.defineTheme('leanlander', {
    ...
    inherit: true,
    rules: [
      { token: 'comment', foreground: '65726A', fontStyle: 'italic' },
      { token: 'comment.doc', foreground: '53675A', fontStyle: 'italic' },
      { token: 'identifier', foreground: '17201C' },
      { token: 'keyword', foreground: 'B42318', fontStyle: 'bold' },
      { token: 'keyword.tactic', foreground: '007A5E', fontStyle: 'bold' },
      { token: 'number', foreground: 'B54708' },
      { token: 'operator', foreground: '0E7490' },
      { token: 'string', foreground: 'A23E14' },
    ],
    colors: {
  ...
  monaco.editor.defineTheme('leanlander-dark', {
    ...
    rules: [
      ...
      { token: 'keyword', foreground: 'FF8A80', fontStyle: 'bold' },
      { token: 'keyword.tactic', foreground: '46D7A4', fontStyle: 'bold' },
      { token: 'number', foreground: 'FFC266' },
      { token: 'operator', foreground: '67D4E8' },
      { token: 'string', foreground: 'FFAA72' },
    ],
    colors: {
